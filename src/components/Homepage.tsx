            ...
            <p>
              <div className="socials">
                <a
                  ...
                  target="_new"
                  href="https://www.facebook.com/alishadman123"
                >
                  <i>
                    <svg
                      aria-hidden="true"
                      ...
                      viewBox="0 0 320 512"
                      className="social-icon-svg svg-inline--fa fa-w-10"
                    >
                      <path
                        fill="currentColor"
                ...
                <a
                  ...
                  rel="nofollow external noopener noreferrer"
                  target="_new"
                  href="https://twitter.com/AliShadman13"
                >
                  <i>
                    <svg
                      aria-hidden="true"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 512 512"
                      className="social-icon-svg svg-inline--fa fa-w-16"
                    >
                      <path
                        fill="currentColor"
                ...
                <a
                  ...
                  rel="nofollow external noopener noreferrer"
                  target="_new"
                  href="https://www.instagram.com/alishadman95/"
                >
                  <i>
                    <svg
                      aria-hidden="true"
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 448 512"
                      className="social-icon-svg svg-inline--fa fa-w-14"
                    >
                      <path
                        fill="currentColor"
                ...
                <a
                  ...
                  rel="nofollow external noopener noreferrer"
                  target="_new"
                  href="https://www.linkedin.com/in/ali-shadman-60aba1193/"
                >
                  <i>
                    <svg
                      aria-hidden="true"
                ...
                <a
                  ...
                  rel="nofollow external noopener noreferrer"
                  target="_new"
                  href="https://github.com/AliShadman95"
                >
                  <i>
                    <svg
                      aria-hidden="true"
