...
gulp.task("build-css", function () {
	return gulp
		.src([
			`./themes/${config.site.theme}/css/vendor/bulma/bulma.min.css`,
			`./themes/${config.site.theme}/css/main.scss`,
			`./themes/${config.site.theme}/css/social.scss`,
			`./themes/${config.site.theme}/css/animate.scss`,
		])
...
gulp.task("build-css-skeleton", function () {
	return gulp
		.src([`./themes/${config.site.theme}/css/skeleton.scss`])
...
gulp.task("build-css-skin-default", function () {
	return gulp
		.src([`./themes/${config.site.theme}/css/skin-default.scss`])
...
gulp.task("build-css-skin-nightmode", function () {
	return gulp
		.src([`./themes/${config.site.theme}/css/skin-nightmode.scss`])
...
gulp.task("build-js", function () {
	let jsarray = [
		`./themes/${config.site.theme}/js/vendor/cash-dom/cash.min.js`,
		`./themes/${config.site.theme}/js/vendor/lazyload/lazyload.min.js`,
		`./themes/${config.site.theme}/js/main.js`,
		`./themes/${config.site.theme}/js/pwa/prompt.js`,
		`./themes/${config.site.theme}/js/pwa/update.js`,
		`./themes/${config.site.theme}/js/skin-switcher.js`,
		`./themes/${config.site.theme}/js/policy/cookielaw.js`,
		`./themes/${config.site.theme}/js/main.js`,
		`./themes/${config.site.theme}/js/events.js`,
	];
...
gulp.task(
	"build-css-skin",
	gulp.parallel("build-css-skin-default", "build-css-skin-nightmode")
);
gulp.task(
	"build-static",
	gulp.parallel(
...
gulp.task("browser-sync", function () {
	...
	nodemon({
		...
		watch: [
			...
			`./themes/${config.site.theme}/js/pwa/*.js`,
			`./themes/${config.site.theme}/js/policy/*.js`,
		],
		ext: "js, html, css",
	}).on("restart", function () {
		browsersync.reload();
	...
	gulp.watch([
		`./themes/${config.site.theme}/**/*.scss`,
		`!./themes/${config.site.theme}/css/skeleton.scss`,
		`!./themes/${config.site.theme}/css/skin-default.scss`,
		`!./themes/${config.site.theme}/css/skin-nightmode.scss`,
	]).on("change", gulp.parallel("build-css"));
	gulp.watch([`./themes/${config.site.theme}/css/skeleton.scss`]).on(
		"change",
		gulp.parallel("build-css-skeleton")
	);
	gulp.watch([
		`./themes/${config.site.theme}/css/skin-default.scss`,
		`./themes/${config.site.theme}/css/skin-nightmode.scss`,
	]).on("change", gulp.parallel("build-css-skin"));

	gulp.watch([
		"./configs",
		"./modules",
		"./translations",
		`./themes/${config.site.theme}/js/*.js`,
		`!./themes/${config.site.theme}/js/full.min.js`,
	]).on("change", gulp.parallel("build-js"));
});
