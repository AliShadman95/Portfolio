...
gulp.task("build-css", function() {
	return gulp.src([`./themes/${config.site.theme}/css/vendor/bulma/bulma.min.css`, `./themes/${config.site.theme}/css/main.scss`, `./themes/${config.site.theme}/css/social.scss`, `./themes/${config.site.theme}/css/animate.scss`])
...
gulp.task("build-js", function() {
	let jsarray = [`./themes/${config.site.theme}/js/vendor/cash-dom/cash.min.js`, `./themes/${config.site.theme}/js/vendor/lazyload/lazyload.min.js`, `./themes/${config.site.theme}/js/main.js`, `./themes/${config.site.theme}/js/pwa/prompt.js`, `./themes/${config.site.theme}/js/pwa/update.js`, `./themes/${config.site.theme}/js/skin-switcher.js`, `./themes/${config.site.theme}/js/policy/cookielaw.js`, `./themes/${config.site.theme}/js/main.js`, `./themes/${config.site.theme}/js/events.js`];
...
gulp.task("browser-sync", function() {
	...
	gulp.watch(["./configs", "./modules", "./translations", `./themes/${config.site.theme}/js/*.js`, `!./themes/${config.site.theme}/js/full.min.js`]).on("change", gulp.parallel("build-js"));
});
